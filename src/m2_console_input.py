...
def double_a_float():
    ...
    # ------------------------------------------------------------------
    dollars = float(input('How much money do you want?'))
    print(dollars * 2)
...
def print_an_integer_many_times():
    ...
    positive = int(input('Give me a positive number'))
...
def print_an_integer_many_times_on_one_row():
    ...
    number = int(input('give me another positive number'))
    s = ''
    doubled = number * 2
...
def input_it_all():
    ...
    f = float(input('float me'))
    i = int(input('number me'))
    s = str(input('whats your name'))
